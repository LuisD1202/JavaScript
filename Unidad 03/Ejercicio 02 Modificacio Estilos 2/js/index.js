...
function activaraudio(){
  document.getElementById("speaker-audio").checked=false
  document.querySelector(".audio img").setAttribute("src","img/sepaker.png");
}

function activaraudio(){
  document.getElementById("speaker-audio").checked=true
